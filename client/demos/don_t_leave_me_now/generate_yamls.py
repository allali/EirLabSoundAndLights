...
from light import YamlWritter, YamlEffectWritter, lightConfig
import numpy as np
...
YamlEffectWritter.circle_appear(hg, radius, t0, t0+1300, bleu_clair, yw1)
YamlEffectWritter.circle_appear(hd, radius, t1, t1+1300, rouge, yw2)
YamlEffectWritter.circle_appear(bg, radius, t2, t2+1300, bleu, yw3)
YamlEffectWritter.circle_appear(bd, radius, t3, t3+1300, violet, yw4)
...
YamlEffectWritter.circle_appear((lightConfig.LIGHTS_COORDINATES[27]+lightConfig.LIGHTS_COORDINATES[26])/2, 40, 37370, 37800, rouge2, yw5)
...
YamlEffectWritter.ring_appear(lightConfig.LIGHTS_COORDINATES[12], 20, 39320, 39560, rouge3, yw6)
YamlEffectWritter.set_color(yw6, [0,0,0,0], 39790, 1)

YamlEffectWritter.set_color(yw6, [0,0,0,0], 40410-27)
YamlEffectWritter.ring_appear(lightConfig.LIGHTS_COORDINATES[46], 20, 40410, 40710, rouge3, yw6)
YamlEffectWritter.set_color(yw6, [0,0,0,0], 41010, 1)

YamlEffectWritter.set_color(yw6, [0,0,0,0], 42650-27)
YamlEffectWritter.ring_appear(lightConfig.LIGHTS_COORDINATES[10], 20, 42650, 42950, rouge3, yw6)
YamlEffectWritter.set_color(yw6, [0,0,0,0], 43350, 1)

YamlEffectWritter.ring_appear(lightConfig.LIGHTS_COORDINATES[48], 20, 44400, 44900, rouge3, yw6)
YamlEffectWritter.set_color(yw6, [0,0,0,0], 45800, 1)

YamlEffectWritter.ring_appear(lightConfig.LIGHTS_COORDINATES[27], 20, 46630, 47000, rouge3, yw6)
YamlEffectWritter.set_color(yw6, [0,0,0,0], 47400, 1)

YamlEffectWritter.set_color(yw6, [0,0,0,0], 47440, 1)
YamlEffectWritter.ring_appear(lightConfig.LIGHTS_COORDINATES[27], 20, 47480, 47780, rouge3, yw6)
YamlEffectWritter.set_color(yw6, [0,0,0,0], 47900, 1)

YamlEffectWritter.ring_appear(lightConfig.LIGHTS_COORDINATES[8], 20, 48200, 48750, rouge3, yw6)
YamlEffectWritter.set_color(yw6, [0,0,0,0], 48800, 1)

YamlEffectWritter.ring_appear(lightConfig.LIGHTS_COORDINATES[8], 20, 48830, 49200, rouge3, yw6)
...
yw1 = YamlWritter("rect1.yaml")

YamlEffectWritter.set_color(yw1, [0,0,0,0], 0)
YamlEffectWritter.set_color(yw1, [0,0,0,0], t0-45)

YamlEffectWritter.rectangle_appear(s1, s2, dim, t0, t1-27, bleu_clair, yw1)
YamlEffectWritter.rectangle_appear(s2, s3, dim2, t1, t2-27, bleu_clair, yw1)
YamlEffectWritter.rectangle_appear(s3, s4, dim, t2, t3-27, bleu_clair, yw1)
#YamlEffectWritter.rectangle_appear(s4, s1, dim, t3, t4, bleu_clair, yw1)
...
########################################################
yw2 = YamlWritter("rect2.yaml")

YamlEffectWritter.set_color(yw2, [0,0,0,0], 0)
YamlEffectWritter.set_color(yw2, [0,0,0,0], t0-45)

YamlEffectWritter.rectangle_appear(s2, s3, dim2, t0, t1-27, rouge, yw2)
YamlEffectWritter.rectangle_appear(s3, s4, dim, t1, t2-27, rouge, yw2)
YamlEffectWritter.rectangle_appear(s4, s1, dim, t2, t3-27, rouge, yw2)
#YamlEffectWritter.rectangle_appear(s1, s2, dim, t3, t4, rouge, yw2)
...
########################################################
yw3 = YamlWritter("rect3.yaml")

YamlEffectWritter.set_color(yw3, [0,0,0,0], 0)
YamlEffectWritter.set_color(yw3, [0,0,0,0], t0-45)

YamlEffectWritter.rectangle_appear(s3, s4, dim, t0, t1-27, bleu, yw3)
YamlEffectWritter.rectangle_appear(s4, s1, dim, t1, t2-27, bleu, yw3)
YamlEffectWritter.rectangle_appear(s1, s2, dim, t2, t3-27, bleu, yw3)
#YamlEffectWritter.rectangle_appear(s2, s3, dim, t3, t4, bleu, yw3)
...
########################################################
yw4 = YamlWritter("rect4.yaml")

YamlEffectWritter.set_color(yw4, [0,0,0,0], 0)
YamlEffectWritter.set_color(yw4, [0,0,0,0], t0-45)

YamlEffectWritter.rectangle_appear(s4, s1, dim, t0, t1-27, violet, yw4)
YamlEffectWritter.rectangle_appear(s1, s2, dim, t1, t2-27, violet, yw4)
YamlEffectWritter.rectangle_appear(s2, s3, dim2, t2, t3-27, violet, yw4)
#YamlEffectWritter.rectangle_appear(s3, s4, dim, t3, t4, violet, yw4)
...
yw5 = YamlWritter("saxo.yaml")

dimSax = np.array([50, 2.5])
YamlEffectWritter.set_color(yw5, [0,0,0,0], 0)
YamlEffectWritter.set_color(yw5, [0,0,0,0], tsax-27)

YamlEffectWritter.rectangle_appear(lightConfig.LIGHTS_COORDINATES[3], lightConfig.LIGHTS_COORDINATES[51], dimSax, tsax, tfsax, vert, yw5, 60)
