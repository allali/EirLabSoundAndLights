...
def light_yaml_from_rectangle(center, dimensions:List[int], t0:int, rgbw:List[int], lightId, ym:YamlWritter):
...
def rectangle_appear(start, stop, dimensions:int, t0:int, t1:int, rgbw:List[int], ym:YamlWritter, precision=200):
...
rectangle_appear(s1, s2, dim, t0, t1-27, bleu_clair, yw1)
rectangle_appear(s2, s3, dim2, t1, t2-27, bleu_clair, yw1)
rectangle_appear(s3, s4, dim, t2, t3-27, bleu_clair, yw1)
...
rectangle_appear(s2, s3, dim2, t0, t1-27, rouge, yw2)
rectangle_appear(s3, s4, dim, t1, t2-27, rouge, yw2)
rectangle_appear(s4, s1, dim, t2, t3-27, rouge, yw2)
...
rectangle_appear(s3, s4, dim, t0, t1-27, bleu, yw3)
rectangle_appear(s4, s1, dim, t1, t2-27, bleu, yw3)
rectangle_appear(s1, s2, dim, t2, t3-27, bleu, yw3)
...
rectangle_appear(s4, s1, dim, t0, t1-27, violet, yw4)
rectangle_appear(s1, s2, dim, t1, t2-27, violet, yw4)
rectangle_appear(s2, s3, dim2, t2, t3-27, violet, yw4)
