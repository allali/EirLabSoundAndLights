...
#add to yaml
ym = yaml_writer("feeling_good/random_lights")
...
for i in range(54):
    ym.add(i, instrument2-20, 255, 255, 255, 0, 0)
    ym.add(i, instrument2+50, 0, 0, 0, 0, 0)

circle_drawer.ring_appear(center, 30, instrument3-200, instrument3+600, np.array([255, 255, 255, 0]), ym)
# circle_drawer.ring_appear(center, 30, instrument4, instrument4+500, np.array([255, 255, 255, 0]), ym)
for i in range(54):
    ym.add(i, instrument4-20, 255, 255, 255, 0, 0)
    ym.add(i, instrument4+50, 0, 0, 0, 0, 0)
circle_drawer.ring_appear(center, 30, instrument5-200, instrument5+600, np.array([255, 255, 255, 0]), ym)
# circle_drawer.ring_appear(center, 30, instrument6, instrument6+500, np.array([255, 255, 255, 0]), ym)
for i in range(54):
    ym.add(i, instrument6-20, 255, 255, 255, 0, 0)
    ym.add(i, instrument6+50, 0, 0, 0, 0, 0)
circle_drawer.ring_appear(center, 30, instrument7-200, instrument7+400, np.array([255, 255, 255, 0]), ym)
# circle_drawer.ring_appear(center, 30, instrument8, instrument8+400, np.array([255, 255, 255, 0]), ym)
for i in range(54):
    ym.add(i, instrument8-20, 255, 255, 255, 0, 0)
...
for i in range(54):
    ym.add(i, instrument9-20, 255, 255, 255, 0, 0)
...
for i in range(54):
    ym.add(i, instrument10-20, 255, 255, 255, 0, 0)
...
for i in range(54):
    ym.add(i, instrument11-20, 255, 255, 255, 0, 0)
    ym.add(i, instrument11+50, 0, 0, 0, 0, 0)

circle_drawer.ring_appear(center, 30, instrument12-200, instrument12+800, np.array([255, 255, 255, 0]), ym)
ym.write()
